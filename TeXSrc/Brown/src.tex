...
\normalsize of \yourname\ (Mathematics Ph.D. applicant for Fall---2020)
\end{center}
...
excited to apply to Brown, one of the stronger schools directly in my interests.
With respect to specific professors, {\em Professor Guzman's} work on the theory
of finite elements is appealing to me, for example the work constructing FE-pairs
for the arbitrary dimensional Stokes problem on barycentric refinements via
deriving a local inf-sup condition for this case. I would also be interested in
his work in discontinuous Galerkin, but I have only just touched that subject,
and can't say much about it yet. In addition, {\em Professor Shu} shares
interests with me in spectral methods, a class of methods which I've always
found interesting. Finally, {\em Professor Karniadakis'} work in high
performance and parallel computing, a field that I have large interests in, is
also appealing to me. For example, his paper on PPINN for time dependent PDEs is
an interesting generalization of the parareal idea I'm so familiar with, let
alone the general idea of developing DNNs to solve PDEs, which is novel to me.
I had hope of getting my hands dirty in developing GPU based methods for
numerical PDE, so I'm excited to get involved in projects leveraging GPU
friendly techniques, especially since Brown has the cluster {\em Oscar} which
has 23 GPU nodes by itself. In short, there are many avenues for me to grow here
at Brown, and thus I would very happy to join the department.
