...
excited to apply to the University of Utah, one of the stronger schools directly
in my interests. In the department of mathematics, {\em Professor Narayan's}
work is close to what I'd like to research in, specifically his many works on
multifidelity models, and his work on numerical quadrature, including the more
recent paper on the generation of nested quadrature rules via optimization
techniques. In addition, although I recognize that I would need to work on my
physics/biology background to understand the area more, {\em Professor Guevara
Vasquez's} work on cloaking techniques is awesome and {\em Professor Epshteyn's}
work of difference potentials methods on the Chemotaxis model, and general
elliptic and parabolic PDEs interest me. Finally, I hope to be able to work
with a few of the professors at the {\em Scientific Computing and Imaging
institute}, as their {\em scientific computing department's} interests in high
performance computing and the GPU acceleration of ordinary numerical methods is
a big part of my research interest. Although I previously worked with CPU
parallelization in my Parareal project, I hope to get my hands dirty in GPU
acceleration in the numerical solution of differential equations, similar as in
GPUTUM. Therefore, I would be very happy to join the Mathematics department here
at Utah.
