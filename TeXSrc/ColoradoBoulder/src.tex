...
excited to apply to Colorado Boulder, one of the stronger schools directly in my
field. To mention specific professors whose work I find close to what I'm
interested in: {\em Professor Fornberg's} work on generalizing finite difference
methods to scattered node layouts via RBF-FD, {\em Professor Appelö's} recent
work with the graduate student {Fortino Garcia} on WaveHoltz iteration and the
subsequent parallel scalability analysis, and {\em Professor Gillman's} previous
work on solving elliptic PDEs with spectral collocation methods over iterative
schemes, which is a topic I've held I've been very excited to look into ever
since learning pseudospectral methods in my numerical PDE course. Finally,
although {\em Professor Jed Brown} is in the computer science department, his
work on maintaing PETSc is something that I would be interested in getting
involved with. With such opportunities in mine, I would be very happy to join
the applied mathematics department here at Colorado Boulder.
