...
\normalsize of \yourname\ (Applied Mathematics and Computational Science Ph.D. applicant for Fall---2020)
\end{center}
...
excited to apply to Rice, one of the stronger schools directly in my interests.
To that end {\em Professor Chan's} group doing research on numerical methods
which, by preserving the entropy condition upon discretization, achieve long
term stability is interesting to me. Furthermore, his groups work on integrating
GPU-acceleration into your FEM solvers is exciting to me; my work on Parareal
was a combination of MPI over clusters and then OpenMP locally, I have not yet
had the opportunity to apply GPU parallelization to any project. Similarly,
{\em Professor Rivière's} group COMP-M researches similar fields with an
especially strong focus in computational fluid dynamics, which I would be
excited to learn about. Therefore, I would be very happy to join the
computational and applied mathematics department here at Rice.
